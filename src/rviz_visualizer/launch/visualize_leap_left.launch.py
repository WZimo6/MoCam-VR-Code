...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[urdf_file],
            output='screen',
            remappings=[('/joint_states', '/leap_hand_left/target_joint')],  # 重映射 joint_states
        ),
        ...
        Node(
            package='rviz2',
            executable='rviz2',
            arguments=['-d', os.path.join(get_package_share_directory('rviz_visualizer'), 'rviz_config/default_left.rviz')],
            output='screen',
        )
    ])
